                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="">
                        ...
                        <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control" name="d_name" value="{{ old('d_name') }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('no_of_emp') ? ' has-error' : '' }}">
                            <label for="no_of_emp" class="col-md-4 control-label">Company Id</label>
