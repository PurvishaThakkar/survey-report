                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="">
                        ...
                        <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control" name="c_name" value="{{ old('c_name') }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('no_of_emp') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <!-- <input id="no_of_emp" type="no_of_emp" class="form-control" name="no_of_emp" value="{{ old('no_of_emp')}}" required> -->
